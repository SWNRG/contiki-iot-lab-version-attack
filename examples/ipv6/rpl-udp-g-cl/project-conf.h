...
/* Print last part of the address (e.g. 02). Handy for debugging */
#ifndef printShortAddr
#define printShortAddr(addr) printf(" %02x ",((uint8_t *)addr)[15])
#endif
/* Printf full IPv6 address without setting DEBUG_FULL */
...
#define WITH_NON_STORING 0 /* Set this for non-storing mode */
